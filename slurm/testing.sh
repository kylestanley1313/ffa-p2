...
python factor_model_ddp.py --world_size 2 --num_facs 2 --alpha 0 --delta 0.1 --lr 0.05 --max_epochs 100
echo "DONE!"
...
python factor_model_dist.py --world_size 2 --num_facs 2 --alpha 0 --delta 0.1 --lr 0.05 --max_epochs 100
echo "DONE!"