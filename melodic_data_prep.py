...
# the data splits generated by that file.
...
if __name__ == '__main__':
    ...
    if len(args.sz_space) != 2:
        raise("Script only supports 2-D spatial data!")
    ...
    # Create NIFTI file for each subject (concatenating batches)
